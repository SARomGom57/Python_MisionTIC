...
class Aplicacion:   
    def __init__(self):
        ...
        self.lblNum2.grid(row=0, column=1)   
    ...
    def operaciones(self):
        try:
            ...
            mb.showinfo('Información', 'División por 0 no es válida')
        except ValueError:
            mb.showinfo('Error', 'Por favor solo ingrese números')
        except:
